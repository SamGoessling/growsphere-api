...
public class CalendarEvent {
    ...
    public CalendarEvent(Integer id, Plant plant, LocalDate insideSowDate, LocalDate outsideSowDate, LocalDate harvestDate, String sowDescription, String waterFrequency, String waterRequirements) {
        this.id = id;
        this.plant = plant;
